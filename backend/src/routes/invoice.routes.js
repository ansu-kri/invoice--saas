...
const { createInvoice, getInvoice, updateInvoiceStatus, getDashboardsStats, deleteInvoice, downloadInvoice,createPaymentOrder, verifyPayment, sendInvoiceToClient,reminderService } = require("../controllers/invoice.controller");
...
router.get("/reminder-service", protect, permit("admin"), reminderService)
